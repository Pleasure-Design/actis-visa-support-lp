...
class Mailform_Js {
	...
	private $doc                   = 0;
	private $xls                   = 0;
	private $upload_max_size       = 3000000;
	...
	// reCAPTCHA version property
	private $recaptcha_version     = 0;
	
	
	// reCAPTCHA v3 addon property
	private $sitekey_v3            = '';
	
	
	// reCAPTCHA v2 addon property
	private $sitekey_v2            = '';
	...
	public function __construct() {
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/' ) && ! file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/' ) ) {
			$this->recaptcha_version = 3;
		} else if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/' ) && ! file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/' ) ) {
			$this->recaptcha_version = 2;
		}
		
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-config.php' ) && $this->recaptcha_version === 3 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-config.php' );
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/config-include-js.php' );
		}
		
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-config.php' ) && $this->recaptcha_version === 2 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-config.php' );
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/config-include-js.php' );
		}
...
EOM;
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/variable-init-js.php' ) && $this->recaptcha_version === 3 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/variable-init-js.php' );
		}
		
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/variable-init-js.php' ) && $this->recaptcha_version === 2 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/variable-init-js.php' );
		}
	...
	function error_span( e, dt, comment, bool ) {
		...
		if ( bool === true ) {
			var m = e.parents( 'dd' ).find( 'span.error_blank' ).text( dt + 'field has not been filled in' );
		} else {
...
EOM;
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/attachment/clear-display.js' ) ) {
			include( dirname( __FILE__ ) .'/../addon/attachment/clear-display.js' );
		}
		
		if ( file_exists( dirname( __FILE__ ) .'/../addon/attachment/file-clear.js' ) ) {
			include( dirname( __FILE__ ) .'/../addon/attachment/file-clear.js' );
		}
...
EOM;
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-check.js' ) && $this->recaptcha_version === 2 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-check.js' );
		}
...
EOM;
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/grecaptcha-1.js' ) && $this->recaptcha_version === 3 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/grecaptcha-1.js' );
		}
...
EOM;
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/grecaptcha-2.js' ) && $this->recaptcha_version === 3 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/grecaptcha-2.js' );
		}
...
EOM;
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-render.js' ) && $this->recaptcha_version === 3 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-render.js' );
		}
		
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-render.js' ) && $this->recaptcha_version === 2 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-render.js' );
		}
...
EOM;
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/attachment/brackets-add.js' ) ) {
			include( dirname( __FILE__ ) .'/../addon/attachment/brackets-add.js' );
		}
...
EOM;
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-init.js' ) && $this->recaptcha_version === 3 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-init.js' );
		}
		
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-init.js' ) && $this->recaptcha_version === 2 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-init.js' );
		}
...
EOM;
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/attachment/clear-click.js' ) ) {
			include( dirname( __FILE__ ) .'/../addon/attachment/clear-click.js' );
		}
