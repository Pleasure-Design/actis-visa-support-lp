...
class Mailform {
	...
	private $secretkey_v3          = '';
	private $recaptcha_v3_score    = 0.5;
	private $recaptcha_v3_result   = 1;
	private $recaptcha_v3_comment  = 'reCAPTCHA(v3)の検証はNGでした';
	
	
	// reCAPTCHA v2 addon property
	private $secretkey_v2          = '';
	private $recaptcha_v2_result   = 1;
	private $recaptcha_v2_comment  = 'reCAPTCHA(v2)の検証はNGでした';
	...
	public function __construct() {
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-config.php' ) && $this->recaptcha_version === 3 ) {
			...
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/config-include.php' );
		}
		...
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-config.php' ) && $this->recaptcha_version === 2 ) {
			...
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/config-include.php' );
		}
	...
	// public recaptcha_v3_check
	public function recaptcha_v3_check() {
		
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-check.php' ) && $this->recaptcha_version === 3 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-check.php' );
		}
	...
	// public recaptcha_v2_check
	public function recaptcha_v2_check() {
		
		if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-check.php' ) && $this->recaptcha_version === 2 ) {
			include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-check.php' );
		}
	...
	public function mail_set( $set ) {
		...
		if ( $set === 'send' ) {
			...
			if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-ok.php' ) && $this->recaptcha_version === 3 ) {
				include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3-ok.php' );
			}
			
			if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-ok.php' ) && $this->recaptcha_version === 2 ) {
				include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2-ok.php' );
			}
