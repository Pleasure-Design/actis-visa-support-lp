...
if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3.php' ) && ! file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/' ) ) {
	include( dirname( __FILE__ ) .'/../addon/recaptcha-v3/recaptcha-v3.php' );
}

if ( file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2.php' ) && ! file_exists( dirname( __FILE__ ) .'/../addon/recaptcha-v3/' ) ) {
	include( dirname( __FILE__ ) .'/../addon/recaptcha-v2/recaptcha-v2.php' );
}
